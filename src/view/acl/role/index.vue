<template>
    ...
    <el-card style="margin: 10px 0px;">
        <el-button type="primary" size="default" @click="addRole" style="margin: 0 8px  ;"
            v-has="`btn.Role.add`">添加角色</el-button>
        <!-- table展示角色信息 -->
        <el-table @selection-change="" style="margin: 10px 0px;" border :data="roleArr">
            ...
            <el-table-column label="操作" width="300px" align="center">
                <template #="{ row }">
                    ...
                    <el-popconfirm :title="`你确定要删除${row.rolename}?`" width="260px" @confirm="removeRole(row)">
                        <template #reference>
    ...
    <el-dialog v-model="dialogFormVisible" width="500">
        ...
        <template #default>
            <el-form :rules="rules" label-width="80px" :inline="false" :model="roleParams" ref="formRef">
                <el-form-item label="角色名称" prop="roleName" style="margin-top: 50px;">
                    <el-input placeholder="请填写角色名称" v-model="roleParams.roleName" clearable />
                </el-form-item>
            </el-form>
