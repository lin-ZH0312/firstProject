    ...
    <el-card style="margin: 10px 0;">
        ...
        <div v-show="scene == 0">
            <el-button type="primary" size="default" icon="Plus" :disabled="categoryStore.c3Id ? false : true"
                @click="addAttr" v-has="`btn.Attr.add`">添加平台属性</el-button>
            <el-table border style="margin-top:10px ;" :data="attrArr">
                ...
                <el-table-column label="操作" align="center" width="120px">
                    <template #="{ row }">
                        ...
                        <el-popconfirm :title="`是否删除${row.attrName}?`" width="200px" @confirm="deleteAttr(row.id)">
                            <template #reference>
        ...
        <div v-show="scene == 1">
            ...
            <el-table border style="margin-top:10px ;" :data="attrParams.attrValueList">
                <el-table-column label="序号" type="index" align="center" width="80px"></el-table-column>
                <el-table-column label="属性值名称" align="center" width="700px">
                    <template #="{ row, $index }">
                        <el-input :ref="(vc: any) => inputArr[$index] = vc" v-if="row.flag" @blur="toLook(row, $index)"
                            v-model="row.valueName" size="small" placeholder="请你输入属性值名称" clearable />
